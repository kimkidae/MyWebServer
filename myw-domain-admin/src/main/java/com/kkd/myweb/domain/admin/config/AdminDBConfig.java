...
@EnableJpaRepositories(basePackages = {
		"com.kkd.myweb.domain.admin" }, entityManagerFactoryRef = "adminEntityManagerFactory", transactionManagerRef = "adminTransactionManager")
...
public class AdminDBConfig {
	...
	LocalContainerEntityManagerFactoryBean adminEntityManagerFactory(
		...
		var properties = adminHibernateProperties.determineHibernateProperties(adminJpaProperties.getProperties(),
	...
	@Bean
	Repositories getRepositories(@NonNull ApplicationContext applicationContext) {
